// pages/recruitment/recruit/myposition/index.js
var app = getApp()
...
Page({
  ...
  init(page=1) {
    var that = this;
    util.getJSON({
      apiUrl: apiurl.recruit.personPostIndex+'?page='+page,
    }, function (res) {
  ...
  onPullDownRefresh: function () {
    ...
    var that = this;
    util.getJSON({ apiUrl: apiurl.recruit.personPostIndex + '?page=1' }, function (res) {
      var result = res.data.result
      that.setData({
        list: result.list,
        page: result.page,
